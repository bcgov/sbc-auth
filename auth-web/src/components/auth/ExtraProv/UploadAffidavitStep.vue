<template>
    <div>
        <p class="mb-7">This will be reviewed by Registries staff and the account will be approved when
            authenticated.</p>
...
import { getModule } from 'vuex-module-decorators'
  ...
  @Component({
    ...
    computed: {
      ...
      ...mapState('user', ['userProfile', 'currentUser', 'notaryInformation', 'notaryContact'])
    },
    methods: {
      ...mapMutations('org', [
...
export default class UploadAffidavitStep extends Mixins(Steppable) {
    ...
    private readonly setNotaryInformation!: (notaryInformation: NotaryInformation) => void
