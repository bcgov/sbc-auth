<template>
  <div>
    ...
    <ManageBusinessDialog
      ...
      :dialog="manageBusinessDialog"
      :isGovStaffAccount="isGovStaffAccount"
...
import ManageBusinessDialog from './ManageBusinessDialog.vue'
import NameRequestLookup from './NameRequestLookup.vue'
