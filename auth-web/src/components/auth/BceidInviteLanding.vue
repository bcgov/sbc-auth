    ...
    <template v-if="!inviteError">
      ...
      <div class="mt-2" v-if="!isLoading">
        <div class="view-header flex-column mb-10">
          ...
          <p class="my-3">There are a couple of things you'll need to do before logging into BC Registries using BCeID.</p>
        </div>
        <v-card
        ...
        >
          ...
          >
            ...
            <div class="d-flex flex-row mx-9 align-center">
              ...
              <v-icon class="divider-icon mx-2 mt-1">mdi-arrow-down</v-icon>
              <v-divider class=""></v-divider>
            </div>
          </div>
