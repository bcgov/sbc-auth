...
interface BusinessService {
  ...
  createAffiliation: (orgIdentifier: string, entity: Entity) => Promise<AxiosResponse<any>>
}
...
export default {
  ...
  async createAffiliation (orgIdentifier: string, entity: Entity): Promise<AxiosResponse<any>> {
    return Axios.post(`${configHelper.getValue('VUE_APP_AUTH_ROOT_API')}/orgs/${orgIdentifier}/affiliations`, entity)
  }
} as BusinessService
