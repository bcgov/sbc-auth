import { NameRequestLookupResultIF } from '@/models'
import ConfigHelper from '@/util/config-helper'
import { SessionStorageKeys } from '@/util/constants'
import { axios } from '@/util/http-util'

/**
 * Class that provides integration with the NameRequestLookup API.
...
export default class NameRequestLookupServices {
   ...
   */
  static async search (query: string, status = ''): Promise<NameRequestLookupResultIF[]> {
