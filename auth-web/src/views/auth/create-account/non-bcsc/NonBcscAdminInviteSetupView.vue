    ...
    <v-card data-test="nonbcsc-admin-invite-flow" max-width="1028" class="mx-auto">
      <v-container class="wrapper">
        <v-card-title data-test="dialog-header" class="pa-0">
          <h2 class="mb-3">Upload Your Notarized Affidavit</h2>
        </v-card-title>
        <v-card-text class="pa-0">
          <!-- Step 1: upload affidavit-->
          <upload-affidavit-step v-if="isStepOne" :isAdminAffidavitMode="true" @emit-admin-affidavit-complete="isStepOne=true"></upload-affidavit-step>
          <!-- Step 2: upload user profile -->
          <user-profile-form v-else></user-profile-form>
        </v-card-text>
      </v-container>
    </v-card>
  </v-container>
...
export default class NonBcscAdminInviteSetupView extends Vue {
  ...
  private isStepOne: boolean = true
}
</script>
