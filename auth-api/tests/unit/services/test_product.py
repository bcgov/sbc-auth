            ...
            with patch.object(ContactLinkModel, "find_by_user_id", return_value=MockPerson(contact=MockContact())):
                ProductService.update_product_subscription(
                    ProductSubscriptionInfo(
                        product_subscription_id=product_subscription.id, is_approved=True, org_id=org._model.id
                    )
                )
...
def test_get_users_product_subscriptions_kc_groups(session, keycloak_mock, monkeypatch):
    ...
    factory_product_model(
        org_id1, product_code=ProductCode.PPR.value, status_code=ProductSubscriptionStatus.ACTIVE.value
    )
    ...
    factory_product_model(
        org_id1, product_code=ProductCode.BCA.value, status_code=ProductSubscriptionStatus.INACTIVE.value
    )
    factory_product_model(
        org_id1, product_code=ProductCode.BCA.value, status_code=ProductSubscriptionStatus.ACTIVE.value
    )
    factory_membership_model(user4.id, org_id1, member_status=Status.ACTIVE.value)
    ...
    factory_product_model(
        org_id1, product_code=ProductCode.VS.value, status_code=ProductSubscriptionStatus.ACTIVE.value
    )
    factory_product_model(
        org_id1, product_code=ProductCode.VS.value, status_code=ProductSubscriptionStatus.INACTIVE.value
    )
    ...
    factory_product_model(
        org_id2, product_code=ProductCode.PPR.value, status_code=ProductSubscriptionStatus.INACTIVE.value
    )
    factory_product_model(
        org_id2, product_code=ProductCode.VS.value, status_code=ProductSubscriptionStatus.ACTIVE.value
    )
...
def test_get_users_sub_product_subscriptions_kc_groups(session, keycloak_mock, monkeypatch):
    ...
    factory_membership_model(user1.id, org_id1, member_status=Status.ACTIVE.value)
    factory_product_model(
        org_id1, product_code=ProductCode.MHR_QSHM.value, status_code=ProductSubscriptionStatus.ACTIVE.value
    )
    ...
    factory_product_model(
        org_id1, product_code=ProductCode.MHR_QSLN.value, status_code=ProductSubscriptionStatus.ACTIVE.value
    )
    factory_product_model(
        org_id1, product_code=mhr_qsln_code.parent_code, status_code=ProductSubscriptionStatus.ACTIVE.value
    )
