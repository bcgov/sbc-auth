...
def factory_auth_header(jwt, claims):
    """Produces JWT tokens for use in tests."""
...
def test_add_entity(client, jwt, session):  # pylint:disable=unused-argument
    ...
    rv = client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=headers, content_type='application/json')
...
def test_add_entity_invalid_returns_400(client, jwt, session):  # pylint:disable=unused-argument
    ...
    rv = client.post('/api/v1/entities', data=json.dumps(TEST_INVALID_ENTITY_INFO), headers=headers, content_type='application/json')
...
def test_add_entity_no_auth_returns_401(client, session):  # pylint:disable=unused-argument
    ...
    rv = client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=None, content_type='application/json')
...
def test_get_entity(client, jwt, session):  # pylint:disable=unused-argument
    ...
    headers = factory_auth_header(jwt=jwt, claims=TEST_JWT_CLAIMS)
    client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=headers, content_type='application/json')
    rv = client.get('/api/v1/entities/{}'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, content_type='application/json')
...
def test_get_entity_no_auth_returns_401(client, jwt, session):  # pylint:disable=unused-argument
    ...
    headers = factory_auth_header(jwt=jwt, claims=TEST_JWT_CLAIMS)
    client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=headers, content_type='application/json')
    rv = client.get('/api/v1/entities/{}'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=None, content_type='application/json')
    assert rv.status_code == http_status.HTTP_401_UNAUTHORIZED
...
def test_add_contact(client, jwt, session):  # pylint:disable=unused-argument
    ...
    headers = factory_auth_header(jwt=jwt, claims=TEST_JWT_CLAIMS)
    client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=headers, content_type='application/json')
    rv = client.post('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_CONTACT_INFO), content_type='application/json')
    assert rv.status_code == http_status.HTTP_201_CREATED
    dictionary = json.loads(rv.data)
...
def test_add_contact_invalid_format_returns_400(client, jwt, session):  # pylint:disable=unused-argument
    ...
    headers = factory_auth_header(jwt=jwt, claims=TEST_JWT_CLAIMS)
    client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=headers, content_type='application/json')
    rv = client.post('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_INVALID_CONTACT_INFO), content_type='application/json')
    assert rv.status_code == http_status.HTTP_400_BAD_REQUEST
...
def test_add_contact_duplicate_returns_409(client, jwt, session):  # pylint:disable=unused-argument
    ...
    headers = factory_auth_header(jwt=jwt, claims=TEST_JWT_CLAIMS)
    client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=headers, content_type='application/json')
    client.post('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_CONTACT_INFO), content_type='application/json')
    rv = client.post('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_CONTACT_INFO), content_type='application/json')
    assert rv.status_code == http_status.HTTP_409_CONFLICT
...
def test_update_contact(client, jwt, session):  # pylint:disable=unused-argument
    ...
    rv = client.put('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_UPDATED_CONTACT_INFO), content_type='application/json')
...
def test_update_contact_invalid_format_returns_400(client, jwt, session):  # pylint:disable=unused-argument
    ...
    client.post('/api/v1/entities', data=json.dumps(TEST_ENTITY_INFO), headers=headers, content_type='application/json')
    client.post('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_CONTACT_INFO), content_type='application/json')
    rv = client.put('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_INVALID_CONTACT_INFO), content_type='application/json')
    assert rv.status_code == http_status.HTTP_400_BAD_REQUEST
...
def test_update_contact_no_entity_returns_404(client, jwt, session):  # pylint:disable=unused-argument
    ...
    headers = factory_auth_header(jwt=jwt, claims=TEST_JWT_CLAIMS)
    rv = client.put('/api/v1/entities/{}/contacts'.format(TEST_ENTITY_INFO['businessIdentifier']), headers=headers, data=json.dumps(TEST_CONTACT_INFO), content_type='application/json')
    assert rv.status_code == http_status.HTTP_404_NOT_FOUND
