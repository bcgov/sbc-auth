...
JWT_HEADER = {"alg": CONFIG.JWT_OIDC_TEST_ALGORITHMS, "typ": "JWT", "kid": CONFIG.JWT_OIDC_TEST_AUDIENCE}
...
class TestJwtClaims(dict, Enum):
    ...
    public_bceid_account_holder_user = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["public_user", "edit", "account_holder"]},
        "email": "test@test.com",
        "loginSource": LoginSource.BCEID.value,
    }
    ...
    staff_manage_business = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["staff", "edit", "manage_business"]},
        "loginSource": LoginSource.STAFF.value,
    }
    ...
    staff_view_accounts_role = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["staff", "view_accounts"]},
        "loginSource": LoginSource.STAFF.value,
    }
    ...
    staff_manage_accounts_role = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["staff", "view_accounts", "manage_accounts"]},
        "loginSource": LoginSource.STAFF.value,
    }
    ...
    staff_admin_role = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["staff", "view_accounts", "create_accounts"]},
        "roles": ["staff", "edit", "create_accounts"],
        "loginSource": LoginSource.STAFF.value,
    }
    ...
    manage_eft_role = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["staff", "view_accounts", "manage_eft"]},
        "loginSource": LoginSource.STAFF.value,
    }
    ...
    bcol_admin_role = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["staff", "manage_accounts", "view_accounts", "suspend_accounts"]},
        "roles": ["staff", "manage_accounts", "view_accounts"],
    }
    ...
    system_admin_role = {
        ...
        "lastname": fake.last_name(),
        "preferred_username": fake.user_name(),
        "realm_access": {"roles": ["system", "staff", "create_accounts"]},
        "product_code": "ALL",
    }
    ...
    user_test = {
        ...
        "username": "CP1234567",
        "realm_access": {"roles": ["edit", "uma_authorization", "staff"]},
        "loginSource": "PASSCODE",
    }
    ...
    def get_test_real_user(sub, preferred_username=fake.user_name(), access_ype="", roles=[], idp_userid=None):
        ...
        return {
            ...
            "realm_access": {"roles": ["edit", "public_user", *roles]},
            "roles": ["edit", "public_user", *roles],
        }
...
class TestOrgInfo(dict, Enum):
    ...
    org_regular_bceid = {"name": "My Test Org", "accessType": AccessType.REGULAR_BCEID.value}
    ...
    org_with_products = {
        "name": "My Test Org",
        "paymentInfo": {"paymentMethod": "ONLINE_BANKING"},
    ...
    def bcol_linked():
        ...
        return {
            ...
            "bcOnlineCredential": {"userId": "test", "password": "password"},
...
class TestOrgProductsInfo(dict, Enum):
    ...
    org_products2 = {"subscriptions": [{"productCode": "VS"}, {"productCode": "PPR"}]}
...
class TestEntityInfo(dict, Enum):
    ...
    bc_entity_passcode3 = {
        "businessIdentifier": "CP123456890",
    ...
    bc_entity_passcode4 = {
        "businessIdentifier": "CP123456891",
        "businessNumber": "791861078BC0003",
        "name": "BarFoo, Inc.4",
        "passCode": "222222222",
        "corpTypeCode": "BC",
    }
    entity_reset_passcode = {
        "businessIdentifier": "CP1234567",
        "resetPasscode": True,
    ...
    entity_lear_mock3 = {
        ...
        "businessNumber": "791861078BC0002",
        "name": "Foobar, Inc.",
        "passCode": "Horton, Connor",
        "corpTypeCode": "SP",
    }

    entity_folio_number = {"businessIdentifier": "CP1234568", "folioNumber": "12345678"}

    name_request = {"businessIdentifier": "NR 1234567", "name": "ABC Corp Inc.", "corpTypeCode": "NR"}

    temp_business = {"businessIdentifier": "QWERTYUIO", "name": "NR 1234567", "corpTypeCode": "TMP"}

    temp_business_incoporated = {"businessIdentifier": "QWERTYUIO", "name": "BC1234567890", "corpTypeCode": "TMP"}
...
class TestAffliationInfo(dict, Enum):
    ...
    new_business_affiliation = {
        "businessIdentifier": "CP1234568",
        "certifiedByName": "John Wick",
        "phone": "1112223333",
        "email": "test@test.com",
    }
...
class TestContactInfo(dict, Enum):
    ...
    contact1 = {"email": "foo@bar.com", "phone": "(555) 555-5555", "phoneExtension": "123"}

    contact2 = {"email": "bar@foo.com", "phone": "(555) 555-5555", "phoneExtension": "123"}
...
class KeycloakScenario:
    ...
    def token_info(kc_guid: str):  # pylint: disable=unused-argument; mocks of library methods
        ...
        return {"sub": kc_guid, "username": "public user", "realm_access": {"roles": []}}
...
class TestAffidavit:
    ...
    @staticmethod
    def get_test_affidavit_with_contact(
        doc_id: str = "1234567890987654323456789876543456787654345678.txt",
        ...
        return {
            "issuer": issuer,
            "documentId": doc_id,
            "contact": {"email": email, "phone": "(555) 555-5555", "phoneExtension": "123"},
        }

    @staticmethod
    def get_test_affidavit_with_contact_rejected(
        doc_id: str = "1234567890987654323456789876543456787654345678.txt",
        issuer="ABC Notaries Inc.",
        email="foo@bar.com",
    ):
