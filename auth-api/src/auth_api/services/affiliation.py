...
class Affiliation:
    ...
    def create_affiliation(org_id, business_identifier, pass_code=None, token_info: Dict = None):
        ...
        publish_activity(ActivityAction.CREATE_AFFILIATION.value, 'BUSINESS', entity.name, entity_id)
    ...
    def delete_affiliation(org_id, business_identifier, email_addresses: str = None,
        ...
        publish_activity(ActivityAction.REMOVE_AFFILIATION.value, 'BUSINESS', entity.name, business_identifier)
