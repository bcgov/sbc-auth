...
# Products auto-granted to service-account-provisioned GOVM accounts with the NO_FEE_CODE override.
SERVICE_ACCOUNT_GOVM_FREE_PRODUCTS = [ProductCode.BUSINESS_SEARCH.value]
