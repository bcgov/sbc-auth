...
class Membership(Versioned, BaseModel):  # pylint: disable=too-few-public-methods # Temporarily disable until methods defined
    ...
    status = Column(ForeignKey("membership_status_codes.id"), index=True)
    ...
    def find_membership_by_id(cls, membership_id: int) -> Membership:
        ...
        # Eagerly load all relationships touched by send_notification_to_member and the PATCH handler
        return (
