...
class ProductSubscription(BaseModel):  # pylint: disable=too-few-public-methods
    ...
    product_subscriptipn_roles = relationship('ProductSubscriptionRole', cascade='all,delete,delete-orphan', lazy='select')
