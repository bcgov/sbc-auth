...
Revision ID: 3818a89ddedf
Revises: 886fa2608e93
Create Date: 2021-06-10 11:46:15.867225
...
def upgrade():
    ...
    op.bulk_insert(
        documents,
        [
            {'version_id': '5', 'type': 'termsofuse', 'content': html_content, 'content_type': 'text/html'}
        ]
    )


def downgrade():
    op.execute("DELETE FROM DOCUMENTS WHERE version_id='5' AND type='termsofuse'")
