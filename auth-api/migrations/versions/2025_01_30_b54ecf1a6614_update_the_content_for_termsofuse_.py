"""Update the content for termsofuse version 5

Revision ID: b54ecf1a6614
Revises: beb5b3186f22
Create Date: 2025-01-30 15:49:08.459661
...
revision = 'b54ecf1a6614'
down_revision = 'beb5b3186f22'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    html_content = """
      ...
      <section>
        ...
        <ul>
          ...
          <li><span>p.</span><strong>"Service"</strong> means all products and services available through Service BC Connect that may be utilized by Subscriber or any of its Team Members and includes Access, Transactions and the API;</li>
    ...
    op.execute(
        documents.update()
            .where(documents.c.version_id == op.inline_literal('5') and documents.c.type == 'termsofuse')
