"""Update termsofuse version 4

Revision ID: f1b8e3e2c867
Revises: b54ecf1a6614
Create Date: 2025-01-30 15:52:03.121001
...
revision = 'f1b8e3e2c867'
down_revision = 'b54ecf1a6614'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    html_content = """
      ...
      <section>
        ...
        <ul>
          ...
          <li><span>o.</span><strong>"Service"</strong> means all products and services available through Service BC Connect that may be utilized by Subscriber or any of its Team Members and includes Access, Transactions and the API;</li>
  ...
  """
    ...
    op.execute(
        documents.update()
            .where(documents.c.version_id == op.inline_literal('4') and documents.c.type == 'termsofuse')
