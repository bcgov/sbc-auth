...
Revision ID: 4efb2fdcc1ab
Revises: 08063ceec05d
Create Date: 2020-05-16 16:36:28.249011
...
def upgrade():
    ...
    html_content = """
       ...
       <section>
         ...
         <div>
           ...
           <p><span>g.</span>&nbsp;<strong>"Entity"</strong> means any legal entity (including a registered society, business, or co-operative) for which a User has Access through the Service;</p>
           <p><span>h.</span>&nbsp;<strong>"Fees"</strong> means all fees and charges for the Service, as described in the Business Corporations Act - Schedule (Section 431) Fees, Cooperative Association Act - Cooperative Association Regulation, Schedule A;</p>
           <p><span>i.</span>&nbsp;<strong>"Incorporation Number"</strong> means the unique numerical identifier for a Subscriber’s Entity, and when entered in conjunction with the Passcode, permits a User to perform transactions with regard to that Entity;</p>
           <p><span>j.</span>&nbsp;<strong>"Passcode"</strong> means the unique identifier issued by the Province to a Subscriber with regard to existing Entities on the Service, which enables a User to have Access with regard to those Entities;</p>
           ...
           <p><span>l.</span>&nbsp;<strong>"Service"</strong> means the service operated by the Province that allows a Subscriber to complete Transactions relating to BC Entities or other information accessible through the Website;</p>
           <p><span>m.</span>&nbsp;<strong>"Services Card Number"</strong> means the Subscriber’s BC Services Card number, which authenticates the identity of the Subscriber to the Service;</p>
       ...
       <section>
         ...
         <div>
           ...
           <p><span>2.5</span>The Subscriber will ensure that each of its Users are aware of and comply with the terms of this Agreement as they pertain to the User’s use of the Services.</p>
           <p><span>2.6</span>The Province reserves the right to make changes to the terms of this Agreement at any time without direct notice to either the Subscriber or its Users, as applicable.  The Subscriber acknowledges and agrees that it is the sole responsibility of the Subscriber to review, and, as applicable, to ensure that its Users review, the terms of this Agreement on a regular basis.</p>
           <p><span>2.7</span>Following the date of any such changes, the Subscriber will be conclusively deemed to have accepted any such changes on its own behalf and on behalf of its Users, as applicable.  The Subscriber acknowledges and agrees that each of its Users must also accept any such changes as they pertain to the User’s use of the Services.</p>
         </div>
       </section>
    ...
    op.bulk_insert(
        documents,
        [
            {'version_id': '2', 'type': 'termsofuse', 'content': html_content}
        ]
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute("DELETE FROM DOCUMENTS WHERE version_id='2' AND type='termsofuse'")
    # ### end Alembic commands ###
