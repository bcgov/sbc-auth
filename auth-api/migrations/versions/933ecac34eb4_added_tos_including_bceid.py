"""added tos including bceid

Revision ID: 933ecac34eb4
Revises: da708f932d12
Create Date: 2020-06-24 13:36:41.203489
...
revision = '933ecac34eb4'
down_revision = 'da708f932d12'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.bulk_insert(
        documents,
        [
            {'version_id': '3', 'type': 'termsofuse', 'content': html_content}
        ]
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute("DELETE FROM DOCUMENTS WHERE version_id='3' AND type='termsofuse'")
    # ### end Alembic commands ###
