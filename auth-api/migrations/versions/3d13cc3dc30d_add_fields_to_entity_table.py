...
def upgrade():
    ...
    op.add_column('entity', sa.Column('business_number', sa.String(length=100), nullable=False))
    op.add_column('entity', sa.Column('name', sa.String(length=250), nullable=False))
