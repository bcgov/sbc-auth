...
def upgrade():
    ...
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('STAFF', 'view_active_accounts');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('STAFF', 'view_account_invitations');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('STAFF', 'view_pending_tasks');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('STAFF', 'view_rejected_tasks');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('STAFF', 'view_suspended_accounts');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('STAFF', 'view_inactive_accounts');""")

    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'change_org_name');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'change_role');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'manage_statements');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'remove_business');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'reset_otp');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'reset_password');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'transaction_history');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_activitylog');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_address');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_admin_contact');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_auth_options');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_request_product_package');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_user_loginsource');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_all_products_launcher');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_active_accounts');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_rejected_tasks');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('CC_STAFF', 'view_inactive_accounts');""")
    ...
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('MAXIMUS_STAFF', 'view_all_products_launcher');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('MAXIMUS_STAFF', 'view_active_accounts');""")
    op.execute("""INSERT INTO public.permissions (membership_type_code, actions) VALUES ('MAXIMUS_STAFF', 'view_inactive_accounts');""")
