...
def upgrade():
    ...
    with op.batch_alter_table("affiliation_invitation_types", schema=None) as batch_op:
        batch_op.alter_column("description", existing_type=sa.VARCHAR(length=100), nullable=True)

    with op.batch_alter_table("affiliation_invitations", schema=None) as batch_op:
        batch_op.alter_column(
            "token", existing_type=sa.VARCHAR(length=150), type_=sa.String(length=100), existing_nullable=True
        )
        batch_op.alter_column(
            "is_deleted", existing_type=sa.BOOLEAN(), nullable=True, existing_server_default=sa.text("false")
        )
    ...
    with op.batch_alter_table("product_codes", schema=None) as batch_op:
        batch_op.alter_column(
            "parent_code", existing_type=sa.VARCHAR(length=15), type_=sa.String(length=75), existing_nullable=True
        )
...
def downgrade():
    ...
    with op.batch_alter_table("product_codes", schema=None) as batch_op:
        batch_op.alter_column(
            "parent_code", existing_type=sa.String(length=75), type_=sa.VARCHAR(length=15), existing_nullable=True
        )
    ...
    with op.batch_alter_table("affiliation_invitations", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "is_deleted", existing_type=sa.BOOLEAN(), nullable=False, existing_server_default=sa.text("false")
        )
        batch_op.alter_column(
            "token", existing_type=sa.String(length=100), type_=sa.VARCHAR(length=150), existing_nullable=True
        )

    with op.batch_alter_table("affiliation_invitation_types", schema=None) as batch_op:
        batch_op.alter_column("description", existing_type=sa.VARCHAR(length=100), nullable=False)
