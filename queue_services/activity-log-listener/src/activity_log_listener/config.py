...
CONFIGURATION = {
    'development': 'activity_log_listener.config.DevConfig',
    'testing': 'activity_log_listener.config.TestConfig',
    'production': 'activity_log_listener.config.ProdConfig',
    'default': 'activity_log_listener.config.ProdConfig'
}
