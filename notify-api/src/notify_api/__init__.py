...
from notify_api.models import db, ma
from notify_api.utils.run_version import get_run_version
from notify_api.utils.util_logging import setup_logging
...
def create_app(run_mode=os.getenv('FLASK_ENV', 'production')):
    ...
    from notify_api.resources import API_BLUEPRINT, OPS_BLUEPRINT
